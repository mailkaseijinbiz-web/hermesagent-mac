...
class AppState: ObservableObject {
    ...
    // internal: used by AppState+EmployeeLifecycle (switchEmployee/delegate) + streaming in main.
    var empStreamTexts:  [String: String]   = [:]
    ...
    var modelApplyTask: Task<Void, Never>? = nil
    ...
    var delegationProcess: Process? = nil
    ...
    func parseResponseText(_ raw: String) -> String {
